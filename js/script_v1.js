...
$(function(){
	var canvas = this.__canvas = new fabric.Canvas('canvas', { width: $(window).width(), height: ($(window).height() - 100) });
	...
	fabric.loadSVGFromURL('txt/txt1.svg', function(objects, options) {
 	...
 	fabric.loadSVGFromURL('txt/txt2.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(1.7));
		    shape.set({ left: 0, top: 400 }).setCoords();
		    canvas.renderAll();
 	}); // end fabric

 	fabric.loadSVGFromURL('txt/txt3.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(4.5));
		    shape.set({ left: 1500, top: 400 }).setCoords();
		    canvas.renderAll();
 	}); // end fabric

 	fabric.loadSVGFromURL('txt/txt4.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(1.7));
		    shape.set({ left: 0, top: 400 }).setCoords();
		    canvas.renderAll();
 	...
 	fabric.loadSVGFromURL('txt/txt5.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(1.7));
		    shape.set({ left: 0, top: 400 }).setCoords();
		    canvas.renderAll();
 	...
 	fabric.loadSVGFromURL('txt/txt6.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(4.5));
		    shape.set({ left: 1500, top: 0 }).setCoords();
		    canvas.renderAll();
 	}); // end fabric

 	fabric.loadSVGFromURL('txt/txt7.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(4.5));
		    shape.set({ left: 1500, top: 700 }).setCoords();
		    canvas.renderAll();
 	}); // end fabric

 	fabric.loadSVGFromURL('txt/txt8.svg', function(objects, options) {
    	var shape = fabric.util.groupSVGElements(objects, options);
		    canvas.add(shape.scale(4.5));
		    shape.set({ left: 1400, top: 700 }).setCoords();
		    canvas.renderAll();
 	}); // end fabric
